...
void ClassPetUI::init() {
  ...
  lv_obj_set_style_text_font(_toast_label, cjkFont(), 0); // 设置中文字体
...
void ClassPetUI::initNormalScreen() {
  ...
  lv_obj_set_style_text_font(_lbl_normal_wifi, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_normal_battery, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_date, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_normal_name, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_normal_lv, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_normal_exp, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(hint, cjkFont(), 0);
...
void ClassPetUI::initDiagScreen() {
  ...
  lv_obj_set_style_text_font(title, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_diag_sugg, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_diag_mac, cjkFont(), 0);
...
void ClassPetUI::initTomatoScreen() {
  ...
  lv_obj_set_style_text_font(lbl_start, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(lbl_cancel, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(title_timer, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(_lbl_tomato_status, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(lbl_p, cjkFont(), 0);
  ...
  lv_obj_set_style_text_font(lbl_e, cjkFont(), 0);
...
void ClassPetUI::initProcessingScreen() {
  ...
  lv_obj_set_style_text_font(_lbl_proc_text, cjkFont(), 0);
...
void ClassPetUI::initMenuScreen() {
  ...
  lv_obj_set_style_text_font(lbl_t, cjkFont(), 0);
  lv_obj_center(lbl_t);
  ...
  lv_obj_set_style_text_font(lbl_v, cjkFont(), 0);
  lv_obj_center(lbl_v);
...
void ClassPetUI::initStandbyScreen() {
  ...
  lv_obj_set_style_text_font(_lbl_standby_date, cjkFont(), 0);
