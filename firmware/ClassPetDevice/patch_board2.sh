cat << 'H_EOF' > firmware/ClassPetDevice/Board.h
/**
 * @file Board.h
...
// ==========================================
#define TFT_BL_PIN             46    // 屏幕背光引脚 (根据文档，LCD_BL 是 GPIO46)
// TFT_CS = 10, TFT_DC = 14 (由 User_Setup.h 或代码底层管理)
...
#endif // BOARD_H
H_EOF
chmod +x firmware/ClassPetDevice/patch_board2.sh
./firmware/ClassPetDevice/patch_board2.sh