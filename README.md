...
- **🎙️ 交互升级「按住说话」**：在 ESP32 设备端屏幕“语音”应用中移除原有的强制读秒倒计时限制，全新引入“按住说话，松开结束”的自然交互体验。保留底层 60 秒极端情况断言保护，支持学生/老师更自由地进行语音沟通。

---

## 🚀 历史版本：v1.6.0 (离线唤醒词与语料库语音控制)
...
### 当前最新版本 v2.2.1 亮点
- 🎙️ 交互升级「按住说话」：设备屏幕引入按住录音、松开发送的流畅交互，移除生硬的读秒倒计时限制。
