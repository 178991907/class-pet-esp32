#line 1 "/Users/Terry/Downloads/class-pet-main/firmware/ClassPetDevice/WebPortal.h"
/**
 * @file WebPortal.h
    ...
    <div class="container">
        ...
        <form action="/save" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="server" name="server" value="https://class-pet-esp32-ten.vercel.app" placeholder="Vercel 域名或本地局域网 IP" required>
            </div>
