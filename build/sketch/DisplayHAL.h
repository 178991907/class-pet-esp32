#line 1 "/Users/Terry/Downloads/class-pet-main/firmware/ClassPetDevice/DisplayHAL.h"
/**
 * @file DisplayHAL.h
...
public:
  ...
  // 12. 更新电量与充电图标
  virtual void updateBatteryStatus(int level, bool isCharging) = 0;

  // 13. 简体中文屏幕报错反馈
  virtual void showChineseErrorScreen(const String& errorTitle, const String& errorDetail) = 0;
};
